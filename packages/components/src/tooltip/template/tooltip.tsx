...
export default defineComponent({
  ...
  setup(props, { slots }): () => VNode {
    ...
    const changeTooltipClick = (): void => {
      trigger === "click" && (isTooltipVisible.value = !isTooltipVisible.value);
    };
    ...
    return () => (
      <div
        class={`se-tooltip ${
          tooltipStyle.value ? Object.keys(tooltipStyle.value).join(" ") : ""
        }`}
      ...
      >
        {/* 默认插槽 */}
        <div class="se-tooltip-text">{slots.default && slots.default()}</div>
        ...
        >
          ...
          >
            ...
            <div class="se-tooltip-arrow">
              <span
                class={[
                  ...
                  isHex() ? "" : `se-tooltip-arrow-${tooltipBgColorProps}`,
                ]}
                style={hexBdColor()}
              ></span>
            </div>
            ...
            <div
              class={[
                "se-tooltip-inner",
                isHex() ? "" : `se-tooltip-inner-${tooltipBgColorProps}`,
              ]}
              style={hexBgColor()}
            >
