  ...
  render() {
    ...
    return (
      <div class={["input-container", sizeClass, borderedClass, disabledClass]}>
        {this.prefix && (
          <se-icon icon={this.prefix} color="gray" class="prefix-icon" />
        )}
        <input
          type={this.type}
          class="input-field"
        ...
        />
        {this.suffix && (
          <se-icon icon={this.suffix} color="gray" class="suffix-icon" />
        )}
