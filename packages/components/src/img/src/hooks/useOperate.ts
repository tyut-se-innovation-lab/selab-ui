...
export default function useOperate(
  ...
  function checkImg() {
    ...
    if (
      ...
      imgStyle.setStyleValue("left", clientWidth / 2 - imgWidth / 2 + "px");
    }
    if (
      imgLeft - imgWidth / 2 > clientWidth / 2 &&
      imgWidth / 2 > clientWidth
    ...
    if (
      ...
      imgStyle.setStyleValue("top", clientHeight / 2 - imgHeight / 2 + "px");
    }
    if (
      imgTop - imgHeight / 2 > clientHeight / 2 &&
      imgHeight / 2 > clientHeight
  ...
  function initToolbarLocation() {
    ...
    if (!_option.modal) {
      ...
      if (
        ...
        toolbarRef.value.style.left = toolbarWidth.value / 2 + 10 + "px";
